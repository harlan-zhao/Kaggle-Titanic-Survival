...
dt = tree.DecisionTreeClassifier(random_state=1,max_depth=7,min_samples_split=2)
dt_result = dt.fit(train,labels)
print(dt_result.score(train,labels))
...
df_test.insert(1,"Survived",result)

final = df_test[["PassengerId","Survived"]]
final.to_csv("DecisionTree.csv")
